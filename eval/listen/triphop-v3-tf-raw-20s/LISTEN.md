# triphop-tf-v3-raw slider — play in order
...
|-----:|------|--------:|----:|-------------------|
| 1 | `01_slider_Pop_minus2.wav` | 20.02 | 0.3496 | more Pop (slider -2) |
| 2 | `02_slider_Pop_minus1.wav` | 20.02 | 0.2370 | more Pop (slider -1) |
| 3 | `03_slider_neutral_base_zero.wav` | 20.02 | 0.0975 | neutral base (slider off) |
| 4 | `04_slider_Trip-hop_plus1.wav` | 20.02 | 0.0213 | more Trip-hop (slider +1) |
| 5 | `05_slider_Trip-hop_plus2.wav` | 20.02 | 0.0035 | more Trip-hop (slider +2) |
