...
|-----:|------|--------:|----:|-------------------|
| 1 | `01_slider_quiet_minus2.wav` | 20.02 | 0.0891 | more quiet (slider -2) |
| 2 | `02_slider_neutral_base_zero.wav` | 20.02 | 0.1119 | neutral base (slider off) |
| 3 | `03_slider_loud_plus2.wav` | 20.02 | 0.1492 | more loud (slider +2) |
| 4 | `04_REF_prompt_loud_no_slider.wav` | 20.02 | 0.1358 | no slider; prompt is the loud caption |
| 5 | `05_REF_prompt_quiet_no_slider.wav` | 20.02 | 0.0770 | no slider; prompt is the quiet caption |
